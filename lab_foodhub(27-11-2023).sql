...
--
-- Host: localhost
-- Generation Time: Nov 27, 2023 at 12:53 PM
...
CREATE TABLE `restaurants` (
  ...
  `restaurant_logo` varchar(300) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT '../restaurants/default.jpg',
  `restaurant_contact` varchar(15) DEFAULT NULL,
  `restaurant_bg` varchar(300) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
